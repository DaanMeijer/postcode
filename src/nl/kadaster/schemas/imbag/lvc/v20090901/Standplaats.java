...
/**
 * Een STANDPLAATS is een formeel door de gemeenteraad als
 * 
 ...
 * 
 * <p>Java class for Standplaats complex type.
 * 
 ...
 *         &lt;element name="standplaatsStatus" type="{http://www.kadaster.nl/schemas/imbag/imbag-types/v20090901}StatusPlaats"/&gt;
 *         &lt;element name="standplaatsGeometrie" type="{http://www.opengis.net/gml}SurfacePropertyType"/&gt;
...
@XmlType(name = "Standplaats", propOrder = {
    "identificatie",
    ...
    extends AdresseerbaarObject implements BaseInterface
{
    ...
    @XmlElement(required = true)
    @XmlSchemaType(name = "string")
    protected StatusPlaats standplaatsStatus;
    @XmlElement(required = true)
    protected SurfacePropertyType standplaatsGeometrie;
    @XmlElement(required = true)
    ...
    /**
     * Gets the value of the standplaatsStatus property.
     * 
     * @return
     *     possible object is
     *     {@link StatusPlaats }
    ...
    /**
     * Sets the value of the standplaatsStatus property.
     * 
     * @param value
     *     allowed object is
     *     {@link StatusPlaats }
     *     
     */
    public void setStandplaatsStatus(StatusPlaats value) {
        this.standplaatsStatus = value;
    }

    /**
     * Gets the value of the standplaatsGeometrie property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public SurfacePropertyType getStandplaatsGeometrie() {
        return standplaatsGeometrie;
    }

    /**
     * Sets the value of the standplaatsGeometrie property.
     * 
     * @param value
     *     allowed object is
     *     {@link SurfacePropertyType }
     *     
     */
    public void setStandplaatsGeometrie(SurfacePropertyType value) {
        this.standplaatsGeometrie = value;
    }
